...
def company_profile(request):
    company_phone= request.session["company_phone"]
    category= JobCategory.objects.all()
    company= Company.objects.filter(company_phone= company_phone)
    return render(request, "employer/profile.html", {'company':company, 'category':category})
